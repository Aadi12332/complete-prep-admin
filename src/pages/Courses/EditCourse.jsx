...
const EditCourse = () => {
  ...
  useEffect(() => {
    ...
    getCourseById({
      setIsLoading,
      setData: (data) => {
        console.log(data?.data?.courseCategoryId?._id);
        reset({
          ...data?.data,
          courseCategoryId: data?.data?.courseCategory?._id,
        });
      },
      id,
    });
          ...
          <div className="dashboardcontainer-header">
            ...
            <p>
              <GoArrowLeft
                ...
                onClick={() => navigate(-1)}
              />
              Dashboard / Course Page /<span> Edit Course</span>
            </p>
          </div>
