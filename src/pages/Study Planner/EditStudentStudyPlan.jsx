...
const EditStudentStudyPlan = () => {
  ...
  useEffect(() => {
    ...
    getStudyPlannerCourseById({ setIsLoading, setData:(res)=>reset({
      ...res,
      studyPlan: res?.studyPlan?._id
    }), id });
  }, []);
  ...
  const onSubmit = (formData) => {
    ...
    editStudyPlannerCourse({ data: payload, addFun });
  };
  return (
    <>
...
export default HOC(EditStudentStudyPlan);
