  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      addCapsuleCourse({
        setIsLoading,
        data: payload,
        addFun: () => navigate("/dashboard/capsule-courses"),
      });
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="dashboardcontainer">
          <div className="dashboardcontainer-header">
            <h6>Capsule Course</h6>
            <p>
              <GoArrowLeft
                size={25}
                style={{ cursor: "pointer" }}
                onClick={() => navigate(`/dashboard/capsule-courses`)}
              />
              Dashboard / Capsule Course Page /<span> Add Capsule Course</span>
            </p>
          </div>
...
export default HOC(AddCapsuleCourse);
