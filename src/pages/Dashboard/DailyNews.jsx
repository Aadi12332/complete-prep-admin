...
const DailyNews = () => {
  ...
  const handleFormSubmit = async (data) => {
    ...
    payload.append("goalCategory", data.goalCategoryId);
    payload.append("goal", data.goalId);
    payload.append("heading", data.heading);
    payload.append("subheading", data.subheading);
    payload.append("image", data.image);
    payload.append("type", "Daily News");
  ...
  return (
    <>
      <CustomModal
        ...
        title={mode ? "Daily News" : "Edit Daily News"}
        bodyContent={
          <div>
            <UniversalForm
              mode={mode}
              ...
              data?.map((item) => (
                <div className="preview-modal-div" key={item._id}>
                  <div className="preview-modal-div-img">
                    <img style={{maxHeight:"200px"}} src={item?.image} alt="" />
                  </div>
