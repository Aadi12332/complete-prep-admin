...
const CapsuleCoursePage = () => {
  ...
  const getData = () => {
    ...
    getBannerByPosition({
      setIsLoading,
      params: { type: "CapsuleCourse", position: "TOP" },
      setData: setBannerData,
    });
    getAllCapsuleCourses({ setIsLoading, setData, params });
  };
  ...
  useEffect(() => {
    const currentBanner = bannerData?.find(
      (banner) => banner.type === "CapsuleCourse"
    );
  ...
  const updateBanner = () => {
    ...
    payload.append("type", "CapsuleCourse");
      ...
      <div className="dashboardcontainer">
        <div className="dashboardcontainer-header">
          ...
          <p>
            <GoArrowLeft
              ...
              onClick={() => navigate(-1)}
            />
            Dashboard /<span> Capsule Course</span>
          </p>
        </div>
        ...
        <div className="handwrittennotes-list">
          <div className="handwrittennotes-list-header">
            <Link to={"/dashboard/add-capsule-courses"} className="link">
              <div className="handwrittennotes-add">
                <FaPlus />
                <h6>Add NEW Capsule Course</h6>
              </div>
            </Link>
...
export default HOC(CapsuleCoursePage);
