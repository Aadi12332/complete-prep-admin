...
const EditTestSeries = () => {
  ...
  useEffect(() => {
    ...
    getTestSeriesById({
      setIsLoading,
      setData: (res) => {
        if (res?.tileImageUrl) setImage(res?.tileImageUrl);
        reset({ ...res });
      },
      id,
    });
        ...
        <div className="dashboardcontainer-header">
          ...
          <p>
            <GoArrowLeft
              ...
              onClick={() => navigate(-1)}
            />
            Quiz app /<span> Edit Test Series</span>
          </p>
        </div>
                ...
                {!show && (
                  <>
                    ...
                    <div className="addhandwritten-input-two-div">
                      ...
                      <div className="addhandwritten-input">
                        <h6>Total Duration of the Bundle (hr)</h6>
                        <div className="addhandwritten-inputs-div">
                          <div className="input-container">
                            <input
                              type="text"
                      ...
                      <div className="addhandwritten-input">
                        ...
                        <div className="addhandwritten-inputs-div">
                          <div className="input-container">
                            ...
                            <label htmlFor="">Want Show In Test Series </label>
                          </div>
                          <div className="addhandwritten-inputs-icons"></div>
                        </div>
                      </div>
...
export default HOC(EditTestSeries);
