...
import { deleteChapter, getAllChapters } from "../../services/exportFunctions";
...
const Chapters = () => {
  ...
  const getData = () => {
    ...
    getAllChapters({ setIsLoading, setData, params });
  };
  useEffect(() => {
    getData();
                    ...
                    <td>
                      <div className="handwrittennotes-table-icons">
                        ...
                        <div className="handwrittennotes-icon">
                          <FiEdit3
                            onClick={() =>
                              navigate(`/chapters/edit-chapter/${data._id}`)
                            }
                          />
                        </div>
                        <div className="handwrittennotes-icon">
